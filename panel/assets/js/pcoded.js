...
$(document).ready(function() {
    ...
    $("#mobile-collapse").on('click', function() {
        if (vw > 991) {
            $(".pcoded-navbar:not(.theme-Cook)").toggleClass("navbar-collapsed");
        }
    });
    ...
    // Menu scroll
    if (!$('.pcoded-navbar').hasClass('theme-Cook')) {
        var vw = $(window)[0].innerWidth;
        if ($('.navbar-content')[0]) {
...
function menuhrres() {
    ...
    if (vw < 992) {
        setTimeout(function() {
            $(".sidenav-Cook-wrapper").addClass("sidenav-Cook-wrapper-dis").removeClass("sidenav-Cook-wrapper");
            $(".theme-Cook").addClass("theme-Cook-dis").removeClass("theme-Cook");
        }, 400);
    } else {
        setTimeout(function() {
            $(".sidenav-Cook-wrapper-dis").addClass("sidenav-Cook-wrapper").removeClass("sidenav-Cook-wrapper-dis");
            $(".theme-Cook-dis").addClass("theme-Cook").removeClass("theme-Cook-dis");
        }, 400);
    }
    // Menu scroll
    setTimeout(function() {
        if ($('.pcoded-navbar').hasClass('theme-Cook-dis')) {
            $(".sidenav-Cook-wrapper-dis").css({
                'height': '100%',
                'position': 'relative'
            });
            if ($('.sidenav-Cook-wrapper-dis')[0]) {
                var px = new PerfectScrollbar('.sidenav-Cook-wrapper-dis', {
                    wheelSpeed: .5,
                    swipeEasing: 0,
                    suppressScrollX: !0,
                    wheelPropagation: 1,
...
$(window).scroll(function() {
    ...
    if (vw >= 768) {
        ...
        if (cOst == 400) {
            $('.theme-Cook').addClass('top-nav-collapse');
        } else if (cOst > ost && 400 < ost) {
            $('.theme-Cook').addClass('top-nav-collapse').removeClass('default');
        } else {
            $('.theme-Cook').addClass('default').removeClass('top-nav-collapse');
        }
        ost = cOst;
    }
});
...
function togglemenu() {
    var vw = $(window)[0].innerWidth;
    if ($(".pcoded-navbar").hasClass('theme-Cook') == false) {
        if (vw <= 1200 && vw >= 992) {
            $(".pcoded-navbar:not(.theme-Cook)").addClass("navbar-collapsed");
        }
        if (vw < 992) {
            $(".pcoded-navbar:not(.theme-Cook)").removeClass("navbar-collapsed");
        }
    }
}
// ===============
...
$.fn.pcodedmenu = function(settings) {
    ...
    var PcodedMenu = {
        ...
        HandleSubMenuTrigger: function() {
            ...
            if ($('.pcoded-navbar').hasClass('theme-Cook') == true || $('.pcoded-navbar').hasClass('theme-Cook-dis') == true) {
                if ((newSize >= 992 && $('body').hasClass('layout-6') || (newSize >= 992 && $('body').hasClass('layout-7')))) {
                    var $dropdown = $("body[class*='layout-6'] .theme-Cook .pcoded-inner-navbar .pcoded-submenu > li.pcoded-hasmenu, body[class*='layout-7'] .theme-Cook .pcoded-inner-navbar .pcoded-submenu > li.pcoded-hasmenu");
                    ...
                    if ($('body').hasClass('layout-6') || $('body').hasClass('layout-7')) {
                        if ($('.pcoded-navbar').hasClass('theme-Cook-dis')) {
                            var $dropdown = $(".pcoded-navbar.theme-Cook-dis .pcoded-inner-navbar .pcoded-submenu > li.pcoded-hasmenu");
                            $dropdown.off('click').off('mouseenter mouseleave').hover(
                                function() {
                                    $(this).addClass('pcoded-trigger').addClass('active');
                                },
                        ...
                        if (!$('.pcoded-navbar').hasClass('theme-Cook-dis')) {
                            var $dropdown = $(".pcoded-navbar:not(.theme-Cook-dis) .pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li");
                        ...
                        if (newSize >= 992) {
                            var $dropdown = $(".pcoded-navbar.theme-Cook .pcoded-inner-navbar .pcoded-submenu > li.pcoded-hasmenu");
                            $dropdown.off('click').off('mouseenter mouseleave').hover(
                                function() {
                                    $(this).addClass('pcoded-trigger').addClass('active');
                                },
                            ...
                            var $dropdown = $(".pcoded-navbar.theme-Cook-dis .pcoded-inner-navbar .pcoded-submenu > li > .pcoded-submenu > li");
                            $dropdown.off('mouseenter mouseleave').off('click').on('click',
                                function() {
                                    var str = $(this).closest('.pcoded-submenu').length;
                                    if (str === 0) {
        ...
        HandleMenuTrigger: function() {
            ...
            var newSize = $window.width();
            if (newSize >= 992) {
                if ($('.pcoded-navbar').hasClass('theme-Cook') == true) {
                    if ((newSize >= 768 && $('body').hasClass('layout-6') || (newSize >= 768 && $('body').hasClass('layout-7')))) {
                        var $dropdown = $("body[class*='layout-6'] .theme-Cook .pcoded-inner-navbar > li,body[class*='layout-7'] .theme-Cook .pcoded-inner-navbar > li ");
                        $dropdown.off('click').off('mouseenter mouseleave').hover(
                            function() {
                                $(this).addClass('pcoded-trigger').addClass('active');
                                if ($('.pcoded-submenu', this).length) {
                                    ...
                                    if (!isEntirelyVisible) {
                                        ...
                                        $('.sidenav-Cook-prev').removeClass('disabled');
                                    } else {
                        ...
                        if ($('body').hasClass('layout-6') || $('body').hasClass('layout-7')) {
                            if ($('.pcoded-navbar').hasClass('theme-Cook-dis')) {
                                var $dropdown = $(".pcoded-navbar.theme-Cook-dis .pcoded-inner-navbar > li");
                                $dropdown.off('click').off('mouseenter mouseleave').hover(
                                    function() {
                                        $(this).addClass('pcoded-trigger').addClass('active');
                                        if ($('.pcoded-submenu', this).length) {
                            ...
                            if (!$('.pcoded-navbar').hasClass('theme-Cook-dis')) {
                                var $dropdown = $(".pcoded-navbar:not(.theme-Cook-dis) .pcoded-inner-navbar > li");
                                $dropdown.off('mouseenter mouseleave').off('click').on('click',
                                    function() {
                                        if ($(this).hasClass('pcoded-trigger')) {
                                            $(this).removeClass('pcoded-trigger');
                            ...
                            var $dropdown = $(".theme-Cook .pcoded-inner-navbar > li");
                            $dropdown.off('click').off('mouseenter mouseleave').hover(
                                function() {
                                    $(this).addClass('pcoded-trigger').addClass('active');
                                    if ($('.pcoded-submenu', this).length) {
    ...
    if (!$('body').hasClass('layout-14')) {
        if (this.href == pageUrl && $(this).attr('href') != "") {
            ...
            if ($('body').hasClass('layout-7') || $('body').hasClass('layout-6')) {
                $(this).parent('li').parent().parent('.pcoded-hasmenu').addClass("active").addClass("pcoded-trigger");
                $(this).parent('li').parent().parent('.pcoded-hasmenu').parent().parent('.pcoded-hasmenu').addClass("active").addClass("pcoded-trigger");
                $('.theme-Cook .pcoded-inner-navbar').find('li.pcoded-trigger').removeClass('pcoded-trigger');
            }
